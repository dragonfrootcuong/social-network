...
const CreateProfile = ({auth, profile: {profile, loading}, getCurrentProfile, createProfile, history}) => {
...
export default connect(mapStateToProp, {getCurrentProfile, createProfile})(withRouter(CreateProfile))
