...
const AddExperience = ({profile: {profile, loading}, addExperience, history, getCurrentProfile}) => {
        ...
        <Fragment>
            <section className="container">
                ...
                <form className="form" onSubmit = {(e) => onSubmit(e)}>
                    ...
                    <div className="form-group">
                    <p><input type="checkbox" name="current" value={current} onClick={(e) => toggleCurrentDate(e)} /> Current Job</p>
                    </div>
                    <div className="form-group">
                    <h4>To Date</h4>
                    <input type="date" name="to" value={to} onChange={(e) => onChange(e)}  disabled={current ? 'disabled' : ''}/>
                    </div>
                    <div className="form-group">
                    <textarea
                        name="description"
